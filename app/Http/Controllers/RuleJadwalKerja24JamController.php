...
class RuleJadwalKerja24JamController extends Controller
{
    /**
...
//        dd($inforekap);
    ...
    public function datarulejadwalpegawai(){
        ...
        ->whereIn('pegawais.id',$datadokter)
        ...
        return Datatables::of($rulejadwal)
            ...
            ->addColumn('aksi', function ($rulejadwal) {
                return '<a class="btn-sm btn-success" href="/jadwalkerjapegawai24/'. encrypt($rulejadwal->id) .'/edit">Edit</a>
                <a class="btn-sm btn-danger" data-method="delete"
                data-token="{{csrf_token()}}" href="/jadwalkerjapegawai24/'. encrypt($rulejadwal->id) .'/hapus">Hapus</a>';
            })
    ...
    public function store(Request $request)
    {
        ...
        //    dd($data);
            ...
            if ($verifikasi>0) {
                return redirect('/jadwalkerjapegawai24')->with('err','Terdapat data jadwal pegawai lebih dari 2 kali pada hari yang sama.');
            }
            else
            {
        ...
        return redirect('/jadwalkerjapegawai24');
    }
    ...
    public function show($id)
    {
        ...
        return view('jadwalkerjapegawai.editjadwalkerjapegawai24',['inforekap'=>$inforekap,'rulejadwals'=>$rulejadwal2,'jadwalkerjas'=>$jadwalkerja]);
    }
