            ...
            @include('layouts.inforekap')
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Download Surat Sakit</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body table-responsive">
                        <form action="/transrekap/download/sakit" method="post">
                            <div class="row">
                                <div class="col-md-12">
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($rekaps as $rekap)
                                <tr>
                                    ...
                                    <td>{{$rekap->lama}}</td>
                                    <td><a class="btn-sm btn-success" href="/transrekap/download/sakit/surat/{{encrypt($rekap->namafile)}}"><i class="fa fa-download"></i></a></td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
