            ...
            @include('layouts.inforekap')
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Download Surat Ijin</h3>
                    </div>
                    <!-- /.box-header -->
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($rekaps as $rekap)
                                <tr>
                                    ...
                                    <td>{{$rekap->lama}}</td>
                                    <td><a class="btn-sm btn-success" href="/transrekap/download/ijin/surat/{{encrypt($rekap->namafile)}}"><i class="fa fa-download"></i></a></td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
