                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                      ...
                                      <form id="formijin" action="/ijin/admin/update/{{$ijin->id}}" method="post" role="form" enctype="multipart/form-data">
                                          <div class="row">
                                              <div class="col-md-12">
                                                  <div class="form-group">
                                                      <label>NIP</label>
                                                      <input id="nip" name="nip" value="{{$ijin->nip}}" readonly class="form-control pull-right" type="text">
                                                  </div>
                                                  <div class="form-group">
                                                      <label>Nama</label>
                                                      <input id="nama" name="nama" value="{{$ijin->nama}}" readonly class="form-control pull-right" type="text">
                                                      {{csrf_field()}}
                                                  </div>
                                                  <div class="form-group">
                                                      <label>Lama Hari</label>
                                                      <input class="form-control" id="lama" type="text" readonly value="{{$ijin->lama}}" name="lama" >
                                                      <input class="form-control" id="id" type="hidden" readonly value="{{$ijin->id}}" name="id" >
                                                  </div>
                                                  <div class="form-group" >
                                                      <label>Sejak Tanggal</label>
                                                      <input id="tanggal" readonly name="tanggal" readonly value="{{$ijin->mulaitanggal}}" class="form-control datepicker pull-right" type="text">
                                                  </div>
                                                  <div class="form-group" >
