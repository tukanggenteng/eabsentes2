                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                        <div class="box-body table-responsive">
                            <form action="/monitoring/instansi/mingguan/{{encrypt($id)}}/{{encrypt($tanggal)}}" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                @foreach($datas as $data)
                                                    <tr>
                                                        <td><a href="/monitoring/instansi/mingguan/detail/{{encrypt($data->pegawai_id)}}/{{encrypt($tanggal)}}/{{encrypt($instansi_id)}}">{{$data->nip}}</a></td>
                                                        <td>{{$data->nama}}</td>                                                        
