                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                        <div class="box-body table-responsive">
                            <form action="{{route('monitoringinstansiminggu')}}" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-7">
                                            ...
                                            <select class="form-control select2" id="instansi_id" value="{{ $instansi_id }}" name="instansi_id[]" data-placeholder="Instansi">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                @foreach($datas as $data)
                                                    <tr>
                                                        <td><a href="/monitoring/instansi/mingguan/{{encrypt($data->instansi_id)}}/{{encrypt($tanggal)}}">{{$data->namaInstansi}}</a></td>
                    ...
                    <div class="box-footer clearfix">
                        <ul class="pagination pagination-sm no-margin pull-right">
                            {{$datas->appends(['jenis_absen'=>($jenis_absen2),'metode'=>($metode),'tanggal'=>$tanggal,'instansi_id'=>$instansi_id])->links()}}
                        </ul>
                    </div>
                </div>
