          ...
          <section class="content">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                        ...
                        <form action="/jadwalkerjapegawaiedit24" method="post">
                            <div class="row">
                                <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body table-responsive">
                            <form action="/hapusjadwalkerjapegawai24" method="post">
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-3">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            oTable = $('#tableaja').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{route('datapegawaijadwalkerja24')}}',
                columns: [
    ...
    <script type="text/javascript">
        ...
        $(function() {
            oTable = $('#tablein').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{route('datapegawairulejadwalkerja24')}}',
                columns: [
                    { data: 'action', name: 'action',orderable: false },
                    { data: 'nip', name: 'nip' },
                    { data: 'nama', name: 'nama' },
